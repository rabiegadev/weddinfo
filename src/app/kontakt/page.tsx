...
export const metadata: Metadata = {
  title: "Kontakt",
  description:
    "Formularz kontaktowy Weddinfo. Otrzymasz numer zlecenia i hasło do statusu.",
};
    ...
    <div className="flex flex-1 flex-col pb-24 md:pb-0">
      <SubpageHero>
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-white/70 sm:text-base">
          Napisz krótką wiadomość. Po wysłaniu otrzymasz e-mail z numerem zlecenia i hasłem do statusu (
          {RESPONSE_TIME_LABEL}).
        </p>
      </SubpageHero>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-[var(--text-muted)]">
                Wypełnione pola są zapamiętywane w tej sesji. Wyczyść formularz, aby zacząć od nowa.
              </p>
              <Link
                href="/zapytanie"
      ...
      <section className="bg-[var(--bg-dark)] py-16 text-center sm:py-20">
        <LandingSectionInner>
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm text-white/55">
            Napisz do nas — chętnie opowiemy o pakietach i pomożemy wybrać rozwiązanie dopasowane do Was.
          </p>
