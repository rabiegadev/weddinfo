...
export function OfferMenu() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute right-0 top-full z-[80] mt-1 min-w-[11.5rem] rounded-xl border border-white/10 bg-[#1f1b17]/96 py-2 text-left shadow-xl backdrop-blur-xl transition-[opacity,visibility] duration-150 ${
